...
from .android_contract import AndroidContract, android_action_plan_digest, android_contract_digest
...
def build_android_runner_config(*, run_id: str, contract: AndroidContract) -> AndroidRunnerConfig:
    ...
    return AndroidRunnerConfig.model_validate({**payload, "config_digest": canonical_digest(payload)})
