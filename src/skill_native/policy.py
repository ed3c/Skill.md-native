...
class ReceiptLedger:
    ...
    Receipts are immutable observations. Provider-side quotas remain separate;
    this ledger enforces operator-defined ceilings regardless of upstream limits.
    """
    ...
    def append(self, receipt: InferenceReceipt) -> None:
