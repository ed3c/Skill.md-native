...
This checklist defines the public repository baseline for Skill.md-native. A checked document means the policy is present; it does not claim that every external runtime, release lane, or production control has been exercised.
